...
async function fetchCountry(name){
   ...
   //   }
      ...
      const languages = country.languages
        ...
        : "N/A";
 //“If country.languages exists, take all its values, join them into a string separated by commas. Otherwise, return "N/A".”
 // .join(",") This converts the array into a string:

...
You are writing a function that calculates a discounted price based on the user’s cart total.
 But something is going wrong — customers are getting wrong discount values, especially when the cart has exact boundary values.

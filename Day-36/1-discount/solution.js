...
- In the original code, the conditions might have been written in ascending order. This logic fails for higher totals like 500,
 because the first condition total >= 100 matches and short-circuits the rest — so 20% Discount is never reached.

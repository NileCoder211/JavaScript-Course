...
// Abstraction is the process of hiding the internal complexities of how something works and only exposing what’s necessary 
// for the user to interact with.

// Encapsulation

// Encapsulation is the bundling of data and methods that operate on that data into a single unit, usually a class — and 
// restricting direct access to some of the object’s components.

// Inheritance

// Inheritance allows one class (child) to reuse the properties and methods of another class (parent), reducing duplication 
// and promoting reusability.

// Polymorphism

// Polymorphism means “many forms” — it allows objects of different classes to be treated as if they are of the same type,
//  but behave differently based on their class-specific implementations.
